...
ReadChar:
    ...
    */
    ...
    LDR        R0, [R1]         // Load UART data register
    TST        R0, #VALID       // Check if data is valid
    MOVEQ      R0, #0           // If not valid, return null
    ANDNE      R0, R0, #0x00FF  // If valid, return character
...
isLetter:
    ...
    -------------------------------------------------------
    */
STMFD     SP!, {LR}			// initialize the stack
...
.data
characterStr: .asciz "Char: "
isLetterStr:  .asciz "Letter: "
isLowerStr:   .asciz "Lower: "
isUpperStr:   .asciz "Upper: "
_Data:
